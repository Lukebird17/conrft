...
class TrainConfig(DefaultTrainingConfig):
    ...
    octo_path = "/home/ziyu/Project/VLA-RL/conrft/octo-small"
    cfg = DictConfig({
        "task": {
            "transforms": {
                "calibration_path": '/home/ziyu/Project/VLA-RL/reactive_diffusion_policy/data/calibration/single_arm'
            }
        }
    })
